<template>
  <el-dialog
    ...
    <el-form-item label="0 正常 1 冻结" prop="status">
      <el-input v-model="dataForm.status" placeholder="0 正常 1 冻结"></el-input>
    </el-form-item>
    <el-form-item label="" prop="notice">
      <el-input v-model="dataForm.notice" placeholder=""></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          status: [
            { required: true, message: '0 正常 1 冻结不能为空', trigger: 'blur' }
          ],
          notice: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ]
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.notice = data.user.notice
              }
            })
          }
        })
